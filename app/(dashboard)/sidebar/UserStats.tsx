        ...
        <div className="flex flex-col items-center w-full text-black font-sans">
            ...
            >
                <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="size-6 lg:group-hover:text-blue-400"
                >
                    <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <div
                ...
                className={`${sidebarLink} group flex items-center gap-2`} // <-- inline layout
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            {isEmployer && (
                <div
                    ...
                    className={`${sidebarLink} group flex items-center gap-2`}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
