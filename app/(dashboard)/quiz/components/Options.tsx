...
export default function Option({ text, isSelected, isAnswer, disabled, onClick }: OptionProps) {
    ...
    if (disabled) {
        if (isSelected && isAnswer) {
            ...
            baseClass += " bg-white border-gray-300 shadow-md hover:scale-[1.02]";
        } else if (!isSelected && isAnswer) {
            ...
            baseClass += " bg-white border-gray-300 text-black shadow-inner hover:scale-[1.02]";
        }
        ...
        baseClass +=
            " bg-white border-gray-300 hover:scale-[1.02] hover:shadow-md";
    }
