...
export default function LoadingBanner() {
    return (
        <div className="w-full h-full flex items-center justify-center bg-black/80 backdrop-blur-md">

            {/* Centered Tesla-style card */}
            <div className="w-96 md:w-[28rem] p-8 bg-black/70 backdrop-blur-xl border border-green-400/20 rounded-2xl shadow-lg flex flex-col items-center">
